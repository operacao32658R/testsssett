(() => {
  ...
  (() => {
    ...
    class c {
      ...
      static getUtmParameters() {
        ...
        let u = a("utm_content"),
          ...
          p = (function (e) {
            const t = (function () {
              ...
              return null !== (r = null == a ? void 0 : a._id) && void 0 !== r
                ? r
                : null;
            })();
        ...
        const v = a("gclid"),
          ...
          h = a("cid");
        i.isCartpanda
          ? f.set("cid", h || Math.round(1e11 * Math.random()).toString())
          : h && f.set("cid", h),
          null != v && "" !== v && f.set("gclid", v),
          f.set("utm_source", p),
          f.set("utm_campaign", d),
          f.set("utm_medium", c),
          f.set("utm_content", u),
          f.set("utm_term", s);
        const g = a("CampaignID"),
          S = a("adSETID"),
          w = a("CreativeID"),
          y = (e) => null != e && "" !== e;
        y(g) &&
          ...
          ((p = `kwai${
            null !==
              (t =
                null === (e = f.get("utm_source")) || void 0 === e
                  ? void 0
                  : e.replace("kwai", "")) && void 0 !== t
              ? t
              : ""
          }`),
          (d = g),
          ...
          f.set("utm_content", u)),
          i.isClickBank
            ? (f.set("aff_sub1", o.UrlRebuilder.removeSpecialCharacteres(p)),
              f.set(
                "aff_sub2",
                o.UrlRebuilder.removeSpecialCharacteres(d).replace(
                  /\|(?=\d{10,}$)(?!.*\|)/,
                  "cKBk"
                )
              ),
              f.set(
                "aff_sub3",
                o.UrlRebuilder.removeSpecialCharacteres(c).replace(
                  /\|(?=\d{10,}$)(?!.*\|)/,
                  "cKBk"
                )
              ),
              ...
              f.set("aff_sub5", o.UrlRebuilder.removeSpecialCharacteres(s)))
            : i.preventSubIds ||
              (f.set("subid", o.UrlRebuilder.removeSpecialCharacteres(p)),
              f.set("sid2", o.UrlRebuilder.removeSpecialCharacteres(d)),
              f.set("subid2", o.UrlRebuilder.removeSpecialCharacteres(d)),
              f.set("subid3", o.UrlRebuilder.removeSpecialCharacteres(c)),
              f.set("subid4", o.UrlRebuilder.removeSpecialCharacteres(u)),
              f.set("subid5", o.UrlRebuilder.removeSpecialCharacteres(d)));
        const b = a("src");
        null != b && "" !== b && f.set("src", b);
        const _ = [p, d, c, u, s],
          U = _.every((e) => "" === e),
          R = a("xcod"),
          P = a("sck");
        if (i.preventXcodSck) R && f.set("xcod", R), P && f.set("sck", P);
        else {
          const e = l(_, r),
            t = (function (e, t, r) {
              ...
              return l(
                [a(o, !0, "jLj"), a(i, !0), a(s, !0), a(u, !0), a(c, !1)],
                r
              );
            })(U ? ("" !== R ? R : b) : e, 0, r);
          f.set("xcod", t), f.set("sck", t);
        }
        const I = n.get("fbclid");
        null != I && "" !== I && f.set("fbclid", I);
        const k = a("utm_id");
        return (
          k && f.set("utm_id", k),
          (() => {
    ...
    function p() {
      ...
      const r = (function () {
        var e, t, r, n, a, o, l, s, u, c, d, m, p, v, f, h, g, S, w, y, b, _;
        const { fixShopifyTheme: U } = i,
          R =
            null !==
              (t =
                null ===
          ...
          N =
            ...
            S,
          q =
            null !== (w = null == R ? void 0 : R.includes("WART")) &&
            void 0 !== w &&
            w,
          M =
